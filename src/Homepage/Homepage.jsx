  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-16 sm:flex-row">
        <div className="mx-auto text-center sm:w-1/2 sm:mr-8">
          ...
          <p className="text-lg text-gray-700 max-w-md mx-auto mt-6 mb-4">
        ...
        <img
          alt="fast-food"
          src={fastFoodImage}
          className="w-full sm:w-1/3 mx-auto border border-gray-300 shadow-md rounded-lg mt-4"
        />
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-lg text-red-600 mt-4 max-w-sm text-center">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            <button
              onClick={onMenu1}
              className="bg-gray-800 hover:bg-gray-700 text-gray-100 font-semibold py-2 px-4 border border-gray-700 rounded shadow mx-4 my-2"
            >
              Burgers
            </button>
            <button
          ...
          <div
            className={
              "bg-yellow-200 flex justify-center mx-auto mt-6 rounded-full  p-4"
            }
            style={{ width: "200px" }}
          >
            {menu1 && <img src={burger} width="70px" alt="menu-food" />}
            {menu2 && <img src={pizza} width="70px" alt="menu-food" />}
            {menu3 && <img src={chicken} width="70px" alt="menu-food" />}
          </div>
            ...
            {menu1 && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {data.slice(0, 3).map((item) => (
                  <div className="bg-yellow-200 border border-red-500 shadow-md rounded-md p-6 flex flex-col justify-between hover:bg-yellow-300">
                    <div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-between mt-20 mb-20">
